...
def main():
    ...
    # Flag variable when a move is made, to prevent regenerating the function pointlessly
    move_made = False
    ...
    while running:
            ...
            if e.type == p.QUIT:
                ...
                if not game_over and human_turn:
                    ...
                    if sqSelected == (row, col):  # The user clicked the same square twice
                        ...
                        sqSelected = (row, col)
                        # Append both the 1st and 2nd clicks
                    ...
                    if len(playerClicks) == 2:  # After 2nd click
                        ...
                        for i in range(len(valid_moves)):
                            if move == valid_moves[i]:
                                ...
                                playerClicks = []
                        if not move_made:
                            # Enables resetting a click when a user clicks on two same-color pieces
        ...
        if not game_over and not human_turn:
            if gs.white_to_move:
                ...
                ai_move = ai.find_minimax_move_iteratively(gs, valid_moves)
...
def highlight_squares(screen, gs, valid_moves, sq_selected):
    ...
    if sq_selected != ():
        r, c = sq_selected
        # sq_selected is a piece that can be moved
        if gs.board[r][c][0] == ('w' if gs.white_to_move else 'b'):
            # Highlight square
            s = p.Surface((SQ_SIZE, SQ_SIZE))
            # transperncy value -> 0: transparent - 255: opaque
            s.set_alpha(150)
...
def draw_board(screen):
    ...
    for r in range(DIMENSION):
        for c in range(DIMENSION):
            color = colors[0] if (r+c) % 2 == 0 else colors[1]
        ...
        for c in range(DIMENSION):
            ...
            if piece != "--":
                screen.blit(IMAGES[piece], p.Rect(
                    SQ_SIZE*c, SQ_SIZE*r, SQ_SIZE, SQ_SIZE))
...
def animate_move(move, screen, board, clock):
    ...
    for frame in range(frame_count + 1):
        ...
        color = colors[1] if (move.end_row + move.end_col) % 2 else colors[0]
